...
class BusView(ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            instance.delete()
            return Response("bus removed")
        except Bus.DoesNotExist:
            return Response("bus not found", status=status.HTTP_404_NOT_FOUND)
...
class BusDriverView(ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            instance.delete()
            return Response("Bus Driver removed")
        except BusDriver.DoesNotExist:
            return Response("Bus Driver not found", status=status.HTTP_404_NOT_FOUND)    
    ...
    def route_assign(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if existing_assignments:
                return Response(data={'msg': 'A bus is already assigned to the route during the same time period'}, status=status.HTTP_400_BAD_REQUEST)
...
class RouteAssignsView(ViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response("RouteAssign Driver not found", status=status.HTTP_404_NOT_FOUND) 
